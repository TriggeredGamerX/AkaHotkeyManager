package net.akatriggered.aka_hotkey_manager.event;

import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents;
import net.fabricmc.fabric.api.client.keybinding.v1.KeyBindingHelper;
import net.akatriggered.aka_hotkey_manager.client.AkaHotkeysManagerClient;
...
public class KeyInputHandler {
    public static final String KEY_CATEGORY = "key.category.akatriggered.aka_hotkey_manager";

    public static final String KEY_ELYTRA = "key.akatriggered.aka_hotkey_manager.equip_elytra";
    public static final String KEY_TOTEM = "key.akatriggered.aka_hotkey_manager.equip_totem";
    ...
    private static void attemptElytraSwap() {
        ...
        PlayerInventory playerInventory = AkaHotkeysManagerClient.CLIENT.player.getInventory();
        ...
        ItemStack offhandSlot = AkaHotkeysManagerClient.CLIENT.player.getOffHandStack();
        ...
        if (swapSlot == -1) {
            AkaHotkeysManagerClient.PlaySound(SoundEvents.BLOCK_NOTE_BLOCK_COW_BELL, 1f);

            return;
        }

        AkaHotkeysManagerClient.CLIENT.interactionManager.clickSlot(
                AkaHotkeysManagerClient.CLIENT.player.playerScreenHandler.syncId,
                firstSlot,
                swapSlot,
                SlotActionType.SWAP,
                AkaHotkeysManagerClient.CLIENT.player
        );

        AkaHotkeysManagerClient.PlaySound(swapIsElytra ? SoundEvents.ITEM_ARMOR_EQUIP_ELYTRA : SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1f, 1f);
    }
    ...
    private static void attemptTotemSwap() {
        ...
        AkaHotkeysManagerClient.PlaySound(SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 1f, 1f);
    }
